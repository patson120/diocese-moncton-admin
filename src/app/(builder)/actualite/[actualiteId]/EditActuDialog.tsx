...
export default function EditActuDialog(
    ...
    const handlePublishActualite = async () => {
        handlePublish({
            ...
            date_planification: `${date}T${hour}:00`
                            ...
                            <CardContent className="p-2.5">
                                ...
                                <div className="flex flex-col items-start gap-1 mt-4">
                                    ...
                                    <div className="flex flex-col items-start gap-[4px] self-stretch w-full">
                                        <HTMLContent html={actualite.titre_fr} className='line-clamp-2 font-bold text-xl' />
                                        <HTMLContent html={actualite.description_fr} className='line-clamp-2' />
                            ...
                            <div className='flex flex-col items-start gap-4 '>
                                <div className="flex flex-col items-start gap-2 self-stretch w-full">
                                    <div className='w-full flex justify-between items-end'>
                                        <label className="mt-[-1.00px] font-body-3 text-noir-dashboard">
                                            Catégorie
                                        </label>
